...
import { addPizzaToCart, decreasePizzasCount, deletePizzaFromCart } from "../redux/reducers/cart"

const CartItem = ({id, price, name, type, size, pizzasAdded, pizzasTotalPrice, imageUrl, pizza}) => {


    const dispatch = useDispatch()

    const onClickPlus = () => {
        dispatch(addPizzaToCart({id, imageUrl, name, price, size, type}))
    }

    const onClickMinus = () => {
        dispatch(decreasePizzasCount({id, size, type}))
    }



    const onDeletePizza = () => {
        dispatch(deletePizzaFromCart({id, size, type}))
    }
